...
/*   Updated: 2019/12/06 14:59:46 by hthomas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	printf("\n^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^TEST 1\n");
	printf("\033[0;32m\t\t||************************* ORIGINAL *************************||   \033[0m\n");
	ret = printf("salut le monde");
	printf("\n\033[0;36mExpected return =\t%d ! \033[0m\n", ret);
	printf("\033[0;32m\t\t||*************************  YOURS   *************************||   \033[0m\n");
	...
	if (countf != 30)
		...
		printf("\n\n\033[1;42m#####################\tYOUR FINAL SCORE : %d/30  (AMAZING :o) \t#####################\033[0m\n", countf);
